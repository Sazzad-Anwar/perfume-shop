...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      {authentication &&
      (authentication.status === "loading" || authentication.data) ? (
        ...
        <div className="container mx-auto lg:py-10">
          <div className="grid grid-cols-1 overflow-hidden rounded-lg shadow-lg lg:grid-cols-2">
            ...
            >
              ...
              >
                <h1 className="mt-10 mb-10 text-center text-3xl font-semibold text-purple-800 lg:mt-0">
                  Create Account
                </h1>
                <Row gutter={[15, 10]}>
                  ...
                  <Col xs={24}>
                    ...
                    >
                      <Checkbox className="text-gray-400">
                        By signing up you agree to our User Agreement, Privacy
                        Policy and Draw Terms & Conditions
                      </Checkbox>
                    </Form.Item>
                  </Col>
